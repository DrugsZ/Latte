...
const testID: DefaultIDType = {
  sessionID: 1,
  localID: 1,
}

export class ShadowGroup extends Container {
  ...
  protected override _appendChild(child: DisplayObject) {
    this._children.push(child)
    console.log('🚀 ~ ShadowGroup ~ _appendChild ~ this:', this)
